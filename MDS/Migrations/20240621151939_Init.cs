        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DrugstoreId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DetailCategory = table.Column<string>(type: "text", nullable: false),
                    BrandId = table.Column<int>(type: "integer", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    Price = table.Column<double>(type: "double precision", nullable: false),
                    PictureUrls = table.Column<List<string>>(type: "text[]", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    Prescription = table.Column<bool>(type: "boolean", nullable: true),
                    ...
                    DrugstoreId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_AspNetUsers_DrugstoreId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserDiscount", x => new { x.DiscountsId, x.DrugstoreId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserDiscount_AspNetUsers_DrugstoreId",
                        column: x => x.DrugstoreId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventories_AspNetUsers_DrugstoreId",
                        column: x => x.DrugstoreId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserDiscount_DrugstoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_DrugstoreId",
                table: "Inventories",
                column: "DrugstoreId");
